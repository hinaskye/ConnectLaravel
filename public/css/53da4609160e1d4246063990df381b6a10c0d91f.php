...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form class="form-horizontal" action="<?php echo e(route('auth.register')); ?>" method="post">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="firstname" value="<?php echo e(old('firstname')); ?>" placeholder="First Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="lastname" value="<?php echo e(old('lastname')); ?>" placeholder="Last Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="inputEmail" name="email" value="<?php echo e(old('email')); ?>" placeholder="Email">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="birthday" name="birthday" value="<?php echo e(old('birthday')); ?>" placeholder="YYYY-MM-DD">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="aboutme" value="<?php echo e(old('aboutme)); ?>" placeholder="Tell us a bit about yourself">
                            </div>
                        </div>
