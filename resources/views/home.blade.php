            ...
            @if($matches[$matchCount]['matchPcent'] != 0)
                <div class="card col-md-4 col-sm-6" ondblclick="like()">
                    ...
                    <div class="card-body">
                    	...
                    	<button type="button" id="chat" class="btn btn-default display-inlineblock" disabled><i class="fa fa-comments fa-2x margin-right-16 text-large text-grey"></i></button>
